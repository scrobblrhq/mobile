...
/// The hosted Scrobblr instance regular users sign in to. Self-hosters point
/// elsewhere via "Advanced options" on the login screen.
const String hostedServerUrl = 'https://scrobblr.app';
...
const String prefLastServerUrl = 'scrobblr.last_server_url';

/// Name used when provisioning the device API token at sign-in.
const String apiTokenName = 'Scrobblr mobile';
